...
def resnet20(num_classes=100, use_norm=False, return_features=False):
    return ResNet_s(BasicBlock, [3, 3, 3], num_classes=num_classes, use_norm=use_norm, return_features=return_features)
...
def resnet44(num_classes=100, use_norm=False, return_features=False):
    return ResNet_s(BasicBlock, [7, 7, 7], num_classes=num_classes, use_norm=use_norm, return_features=return_features)
...
def resnet110(num_classes=100, use_norm=False, return_features=False):
    return ResNet_s(BasicBlock, [18, 18, 18], num_classes=num_classes, use_norm=use_norm, return_features=return_features)
